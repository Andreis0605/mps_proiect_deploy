...
/* -------------------------------------------------------------
   FIXED TYPES FOR CUSTOM TOOLTIP CONTENT
-------------------------------------------------------------- */
...
type CustomTooltipPayload = CustomTooltipPayloadItem[];
...
type CustomTooltipProps = {
  ...
  labelFormatter?: (label: any, payload: CustomTooltipPayload) => React.ReactNode;
  labelClassName?: string;

  formatter?: (
    value: number,
    name: string,
    item: CustomTooltipPayloadItem,
    index: number,
    raw: any
  ) => React.ReactNode;
...
/* -------------------------------------------------------------
   Tooltip Content (Fully Fixed Typing)
-------------------------------------------------------------- */
...
function getPayloadConfigFromPayload(
  ...
  } else if (sub && sub[key] && typeof sub[key] === "string") {
    resolvedKey = sub[key];
  }
