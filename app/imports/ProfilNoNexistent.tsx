...
function Button() {
  return (
    <div className="css-9xzbcn css-n3x9pb css-vc1dd3" data-name="Button">
      <div className="css-9a7aqn css-vkpzlc css-w2w390">
        <p className="css-8zr56v css-evv1mn">Creează-ți un profil</p>
      </div>
    </div>
  );
}
...
function ItemsVariant() {
  return <div className="css-4k5v9r css-hswd6g css-paq0kv" data-name="Items/Variant6" />;
}

function Heading() {
  return (
    <div className="css-55vm49 css-eagkq5 css-i5euys" data-name="Heading">
      <p className="css-8qvbbe css-hef06a css-nf5ac4 css-v27th6">Completează datele de login:</p>
    </div>
  );
}
...
function Input1() {
  return (
    <div className="css-9xnnd css-paq0kv css-xwptil" data-name="Input">
      <p className="css-hef06a css-nf5ac4 css-v27th6 css-y5kdd3">Parola</p>
      <Field1 />
    </div>
  );
}
...
function Button1() {
  return (
    <div className="css-1cq9zg css-i5eux2 css-n3x9pb" data-name="Button">
      <div className="css-9a7aqn css-vkpzlc css-w2w390">
        <p className="css-8zr56v css-evv1mn">Login</p>
      </div>
    </div>
  );
}
...
function Form() {
  return (
    <div className="css-iqrgii css-xnr8ao css-ye66dl" data-name="Form">
      <Heading />
      <Input />
      <Input1 />
      <Button1 />
...
function Checkbox() {
  return (
    <div className="css-njcn2u css-paq0kv css-qpcnvl" data-name="checkbox">
      <p className="css-limyx8 css-nf5ac4 css-pu6bn3">Deja am un profil pe această platformă</p>
    </div>
  );
}
...
function Copy1() {
  return (
    <div className="css-lg0mol css-roiesn" data-name="Copy">
      <Checkbox />
      <div className="css-bbmv0m css-qn57ia css-uzsrki" />
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="css-fuhb4w css-paq0kv css-pgr9xi" data-name="Heading">
      <p className="css-8qvbbe css-hef06a css-nf5ac4 css-v27th6">Ai deja un profil?</p>
    </div>
  );
}

function AiDejaUnProfil() {
  return (
    <div className="css-bz2tic css-tqykku" data-name="Ai deja un profil?">
      <Form />
      <Copy1 />
      <Heading1 />
    </div>
...
export default function ProfilNoNexistent() {
  return (
    <div className="css-bbmv0m css-j9f0op css-vf8mzy" data-name="Profil NONexistent">
      <Button />
      <Group />
      <ItemsVariant />
      <AiDejaUnProfil />
